...
Original file is located at
    https://colab.research.google.com/drive/1furVWn1Q2pp71JFy7sQH6toWRCtlV7JW
"""
...
LISTINGS_PATH = DATA / "listings.csv"  # expects columns: neighbourhood, Price
...
# -----------------------------
# Load listings + build heatmap aggregation from listings
# -----------------------------
@st.cache_data
...
def load_heatmap_from_listings(path: Path) -> pd.DataFrame:
    ...
    # çok az listing olan neighbourhood'ları filtrele (isteğe bağlı)
    agg = agg[agg["listings"] >= 10].copy()

    # color scale clipping (isteğe bağlı ama çok iyi görünür)
...
def investor_page_placeholder():
    ...
    # =========================================================
    # ✅ FORCE WHITE METRICS (place RIGHT BEFORE Key Results)
    # =========================================================
    st.markdown(
        """
        <style>
        ...
        /* Make EVERYTHING inside metric white (Streamlit theme overrides) */
        div[data-testid="metric-container"] *{
            opacity: 1 !important;
        ...
        /* Some Streamlit versions render value as <p> */
        div[data-testid="metric-container"] [data-testid="stMetricValue"] p{
            color: #ffffff !important;
            -webkit-text-fill-color: #ffffff !important;
        }
